...
const RideDetails: React.FC<RideDetailsProps> = ({ ride, onBack, onBook, onChat }) => {
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-6">
        ...
        <div className="bg-gray-50 border-t border-gray-100 p-4 flex flex-wrap gap-4 justify-around text-center">
          ...
          <div>
            ...
            <div className="font-bold text-gray-900">{ride.driver.rating || '4.5'}/5</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex gap-4">
            <div className="relative">
              <img src={ride.driver.avatarUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(ride.driver.name)}&background=10b981&color=fff`} alt={ride.driver.name} className="w-20 h-20 rounded-full object-cover ring-4 ring-gray-100" />
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 mt-1">
                ...
                <span className="font-medium">{ride.driver.rating || '4.5'}/5</span>
                <span className="text-gray-300">•</span>
                <span>{ride.driver.reviewCount || '0'} avis</span>
              </div>
              {ride.driver.isVerified && (
      ...
      <div className="sticky bottom-4 bg-white/95 backdrop-blur-sm p-4 -mx-4 rounded-2xl shadow-lg border border-gray-100">
        ...
        >
          ...
          Réserver pour {ride.price?.toLocaleString('fr-FR') || '0'} {ride.currency || 'XOF'}
        </button>
